...
const DirectorCard = () => {
  ...
  return (
    <div className="p-14 bg-gray-100 flex flex-col items-center">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:w-[1300px] md:h-[300px]">
      ...
      {selectedDirector && (
        <div className="fixed inset-0 bg-black bg-opacity-50  flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg relative  md:w-[60rem] md:h-[25rem]">
            <button
              onClick={closeModal}
            ...
            /> */}
            <div className="mt-4">
              <h2 className="text-xl text-red-700 text-center pb-2  font-bold">
